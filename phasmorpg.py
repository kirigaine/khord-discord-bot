...
traits = [
            ...
            ["Camera Shy","Can't use cameras, can't look at the monitor. Must try to avoid or circumvent camera sightline whenever possible"],
            ...
            ["Diligent","After entering, you aren't allowed to exit the building until you have all 3 ghost evidence"],
